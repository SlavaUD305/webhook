<?php
define('C_REST_CLIENT_ID','local.628da411659319.49534953');//Application ID
define('C_REST_CLIENT_SECRET','aG9SKrlGtkcUQlKpr558XhFI5JnhYRW213mh2mY4Xi7r70CaQe');//Application key
// or
